<?php
	...
	function lib_file_upload( $type )
	{
		...
		/*$dir = WP_CONTENT_DIR . '/uploads/launchcontrol/';*/
		    $upload_dir = wp_upload_dir();
  		    $dir = $upload_dir[ 'basedir' ] . '/launchcontrol/';
            $url = $upload_dir[ 'baseurl' ] . '/launchcontrol/';
		...
		if ( $file['name'] ) {
			...
			/*return WP_CONTENT_URL . '/uploads/launchcontrol/'.$filename;*/
			 return $url . $filename;
		}
		else {
