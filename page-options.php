	...
	function mt_manage_options()
	{
	   ...
	   unset( $mt_option['expiry_date'] );
		...
		<div id="launchcontrol-options" class="wrap">	
			...
			<strong>Help us by making a donation of your choice, to develop this plugin even further. <a href="http://swapycle.co.uk/why-us/" title="Custom Login Redirect" target="">Why You Should Donate</a></strong><p>
			
			<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="MXLYGA4B92K36">
...
<img alt="" border="0" src="https://www.paypalobjects.com/en_GB/i/scr/pixel.gif" width="1" height="1">
				...
				<a href="mailto:info@swapycle.co.uk" title="<?php _e('Contact Support', 'launchcontrol');?>" target="_blank">
					<?php _e('Contact Support', 'launchcontrol');?>
				</a><br><p> 
				<a href="http://wordpress.org/plugins/custom-login-redirect/" title="Custom Login Redirect" target="_blank">Redirect users to custom page on login</a>
				<p>
				<a href="http://wordpress.org/plugins/wp-approve-user/" title="WP Approve User" target="_blank">Approve or unapprove user registrations</a>
							</div>
			<!-- End Contact Support-->		
